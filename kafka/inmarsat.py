...
log_path = config["api"]["inmarsat"]["log_path"]
kafka_broker = config["general"]["kafka"]["broker"]
kafka_topic = config["api"]["inmarsat"]["kafka"]["topic"]
kafka_groupid = config["api"]["inmarsat"]["kafka"]["group.id"]
FILE_PATH=config["api"]["inmarsat"]["data_path"]
